...
import com.mstech.lifeline.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
    ...
    private var _captureViewBinding: ActivityCameraBinding? = null
...
//            initializeQualitySectionsUI()
    ...
    fun stopCapture(){
        ...
        captureViewBinding.captureButton.setImageResource(R.drawable.ic_start)
        captureViewBinding.stopButton.visibility = View.INVISIBLE
        captureViewBinding.stopButton.isEnabled = false
    }
    // ensure the stop button is initialized disabled & invisible
    ...
    fun startCapture() {
        ...
        captureViewBinding.captureButton.isEnabled = false
    }
    /**
    ...
    private fun updateUI(event: VideoRecordEvent) {
        ...
        if(event is VideoRecordEvent.Finalize){
            ...
            ConvertToString(event.outputResults.outputUri)
        }
...
//    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _captureViewBinding = ActivityCameraBinding.inflate(layoutInflater)

        setContentView(captureViewBinding.root)

        intent?.extras?.let {
          helpId =  it.getInt("helpId",0)
        }
